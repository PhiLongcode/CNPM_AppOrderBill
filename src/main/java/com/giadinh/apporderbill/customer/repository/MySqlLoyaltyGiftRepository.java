...
public class MySqlLoyaltyGiftRepository implements LoyaltyGiftRepository {
    private final MySqlConnectionProvider connectionProvider;

    public MySqlLoyaltyGiftRepository(MySqlConnectionProvider connectionProvider) {
    ...
    public Optional<LoyaltyGift> findById(long id) {
        ...
        try (Connection c = connectionProvider.getConnection();
            ...
            System.err.println("MySqlLoyaltyGiftRepository.findById: " + e.getMessage());
        }
    ...
    public void save(LoyaltyGift gift) {
        if (gift.getId() == null) {
            ...
            try (Connection c = connectionProvider.getConnection();
                ...
                System.err.println("MySqlLoyaltyGiftRepository.save insert: " + e.getMessage());
            }
        } else {
            ...
            try (Connection c = connectionProvider.getConnection();
                ...
                System.err.println("MySqlLoyaltyGiftRepository.save update: " + e.getMessage());
            }
        }
    }
    ...
    public void delete(long id) {
        try (Connection c = connectionProvider.getConnection();
            ...
            System.err.println("MySqlLoyaltyGiftRepository.delete: " + e.getMessage());
        }
    }
    ...
    private List<LoyaltyGift> query(String sql) {
        ...
        try (Connection c = connectionProvider.getConnection();
            ...
            System.err.println("MySqlLoyaltyGiftRepository.query: " + e.getMessage());
        }
        return out;
    }
